        ...
        <div class="container mt-4">
            ...
            <form action="equipoSV" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ciudad_equipo" name="ciudad_equipo" required>
                </div>                
            ...
            <form action="partidoSV" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fecha_partido" name="fecha_partido" required>
                </div>     
                <div class="form-group">
                    <label for="equipo1">Id equipo 1:</label>
                    <input type="text" class="form-control" id="id_equipo1" name="id_equipo1" required >
                </div>                
                <div class="form-group">
                    <label for="equipo2">Id equipo 2:</label>
                    <input type="text" class="form-control" id="id_equipo2" name="id_equipo2" required>
                </div>                
                <div class="form-group">
                    <label for="resultadoequipo1">Resultado equipo 1:</label>
                    <input type="text" class="form-control" id="resultado_equipo1" name="resultado_equipo1" required>
                </div>                 
                <div class="form-group">
                    <label for="resultadoequipo2">Resultado equipo 2:</label>
                    <input type="text" class="form-control" id="resultado_equipo2" name="resultado_equipo2" required>
                </div>                  
